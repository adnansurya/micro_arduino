...
void loop() {
    if (WiFi.status() == WL_CONNECTED) {
        ...
        // Generate dummy data untuk simulasi
        ...
        String serverPath = String(serverName) + "?phase_a=" + String(phaseA) + 
        ...
        if (httpResponseCode > 0) {
            ...
            Serial.println("Error in sending GET: " + String(httpResponseCode));
        }
