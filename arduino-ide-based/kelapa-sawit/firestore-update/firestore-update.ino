...
#define API_KEY "AIzaSyBROYVHbhbbsa7KESqpZCH8Hm4mlqx_Rwc"

// User Email and password that already registerd or added in your project.
#define USER_EMAIL "inayahtazkiya18@gmail.com"
#define USER_PASSWORD "inayahtazkiya18"
#define DATABASE_URL "URL"

#define FIREBASE_PROJECT_ID "colordetectedpalmfruit"
...
void loop() {
  ...
  if (app.ready() && (millis() - dataMillis > 60000 || dataMillis == 0)) {
    ...
    String documentPath = "colors/colors";
    ...
    if (!taskcomplete) {
      ...
      Document<Values::ValueM> doc("count", Values::Value(intV));
