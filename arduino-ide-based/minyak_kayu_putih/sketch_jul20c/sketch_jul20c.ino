...
const char* password = "riansaja";

// Ganti dengan token bot Telegram Anda
#define BOT_TOKEN "7258446174:AAGh_mKo6PO7VgdoLoChX1iIdr6QcUZSPCI"
#define CHAT_ID "6292846010"
...
void loop() {
  ...
  while (numNewMessages) {
    for (int i = 0; i < numNewMessages; i++) {
      ...
      if (chat_id == CHAT_ID && millis() - lastTimeSent >= delayBetweenSends) {
        if (text == "/ph") {
